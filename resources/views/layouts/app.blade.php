...
<head>
    ...
    <title>@yield('title', 'POSSAJA')</title>
...
<body class="d-flex flex-column h-100">
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">POSSAJA</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('user.profile', ['id' => 1, 'name' => 'hayyin']) }}">Sample User</a>
                        </li>
                        <li class="nav-item">
    ...
    <footer class="footer mt-auto py-3 bg-dark text-white text-center">
        <div class="container">
            <p class="mb-0">© {{ date('Y') }} POSSAJA. All rights reserved.</p>
        </div>
    </footer>
